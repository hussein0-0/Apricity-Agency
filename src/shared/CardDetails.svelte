...
<style>
  ...
  .container {
    border: 0.13vw solid rgb(169, 121, 50);
    border-radius: 0.5vw;
    width: 14.3vw;
    margin-bottom: 1.5vw;
  ...
  .back {
    ...
    align-items: center;
    justify-content: center;
    border: 0.2vw solid rgb(169, 121, 50);
    box-shadow: -0.15vw 0.25vw 0.4vw rgba(68, 68, 68, 0.3);
  ...
  .links {
    ...
    display: flex;
    align-items: center;
    border: 0.14vw solid rgb(169, 121, 50);
    border-radius: 0.7vw;
    margin: 0.5vw;
    padding-left: 0vw;
    width: 13.5vw;
  ...
  @media (max-width: 1024px) {
    ...
    .links {
      ...
      font-size: 2.3vw;
      padding: 3vw 0;
      border: 0.3vw solid rgb(169, 121, 50);
      border-radius: 1vw;
    }
